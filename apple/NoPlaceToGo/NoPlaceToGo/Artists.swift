...
//    Image("ChrisKokoThomas")]

let artistbios: [artistbio] = [
    artistbio(
        name: "nolan tredway",
        pronouns: "He/Him",
    ...
    artistbio(
        ...
        image: Image("MikeClark")
    ),
    artistbio(name: "Hayley Dixon + Renee Marino",
              ...
              image: Image("HayleyDixon")
    ),
    artistbio(name: "Grace Cooper",
              pronouns: "She/her",
              bio: "Grace Cooper= Grace Cooper is a self taught artist and musician from Oakland Ca. She started drawing at a young age and  is now known for her detailed and unsettling portraits of mainly female subjects. She works primarily with fine point pens and water color.  She is also a singer songwriter and has released multiple home recorded and studio albums, both solo under the name “Grace Sings Sludge” and with the San Francisco group “The Sandwitches”. For her solo project she creates her own music videos and incorporates many elements from her favorite genre of film Horror. ",
              urls: ["www.youtube.com/playlist?list=PL1iJ3IvWHHbOR5lhM0W_Fvm6zB6uoa4hO",
                     "instagram.com/sludgegraceriverperson"],
              image: Image("GraceCooper")
    ),
    artistbio(name: "Chrissy Espinoza",
              pronouns: "She/Her",
              bio: "Chrissy Espinoza grew up in Colorado and has lived throughout the American West. She attended Rocky Mountain College of Art & Design where she studied 2D Animation. She works primary with video, photography and animation. Her short animations have been in independent film and animation festivals in Colorado, the Bay Area and Amsterdam, including P.O.V Animation Festival, Filmhuis Cavia and the Titwrench Art & Music Festival. Espinoza creates surreal environments for her photography which are created from her concepts and imagination. She thoughtfully creates and thinks about every detail for her photoshoots. The act of creating the environment is just as important as taking the photos. Some of her inspiration spawns from installations, surrealism and films. She believes that a great story is key to intriguing the viewer and creating a successful piece of artwork.",
              urls: ["chrissyespinoza.carbonmade.com"],
              image: Image("Chrissy")
    ),
    artistbio(name: "Eriko Tsogo",
              pronouns: "they/she/her",
              bio: "Eriko Tsogo is a Mongolian American cross-disciplinary artist, art management professional and DACA recipient based out of Denver and Los Angeles. She works as the Creative Director at the Mongolian Culture and heritage Center of Colorado. She is an alumni of Denver School of the Arts, having attained her B.F.A from the School of the Museum of Fine Arts. Eriko has had numerous art shows, curatorial projects and artist residencies throughout the US and abroad. Eriko is represented by Tappan Collective in Los Angeles.",
              urls: ["www.erikotsogo.com"],
              image: Image("ErikoTsogo")
    ),
    artistbio(name: "Steven Frost",
              pronouns: "He/Him/His",
              ...
              image: Image("StevenFrost")
    ),
    artistbio(name: "Bryan Costanza",
              pronouns: "he/him/his",
              ...
              image: Image("BryanCostanza")
    ),
    artistbio(name: "Frankie Toan",
              ...
              image: Image("FrankieToan")
    ),
    artistbio(name: "Serena Chopra",
              pronouns: "she/her/hers",
              ...
              image: Image("SerenaChopra")
    ),
    artistbio(name: "Kate Speer",
              pronouns: "she/her/hers",
              ...
              urls: ["katespeerdance.org",
                     "vimeo.com/katespeer"],
              image: Image("KateSpeer")
    ),
    artistbio(name: "BAGBAYSHA",
