...
struct Installation {
    ...
    static let liberace = Installation(
    ...
    static let sleepparalysis = Installation(
    ...
    static let saltpepperghosts = Installation(
    ...
    static let interveningsubstance = Installation(
    ...
    static let solidsjustfluids = Installation(
    ...
    static let waitingroom = Installation(
    ...
    static let dreamsoldwholesale = Installation(
    ...
    static let clownhouse = Installation(
    ...
    static let photobooth = Installation(
    ...
    static let musicscore = Installation(
